...
ConvolutionRendererMask::ConvolutionRendererMask() : GLRenderer() {
    SpecialInit();
}
...
void ConvolutionRendererMask::ResizeGL(int w, int h) {
    // 防止窗口大小变为0
    if (h == 0) h = 1;
    // 重置当前的视口
...
void ConvolutionRendererMask::PassMVPToShader() {
...
void ConvolutionRendererMask::PassWindowToShader() {
...
//void ConvolutionRendererMask::PassLightingToShader() {
...
//void ConvolutionRendererMask::PassMaterialToShader() {
...
void ConvolutionRendererMask::PassRenderModelToShader() {
